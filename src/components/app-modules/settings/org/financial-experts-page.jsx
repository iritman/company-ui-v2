...
import service from "./../../../../services/settings/org/financial-experts-service";
import {
...
import FinancialExpertModal from "./financial-expert-modal";
import FinancialExpertDetailsModal from "./financial-expert-details-modal";
...
const FinancialExpertsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.financial_experts}
            searchText={searchText}
            sheets={getSheets(records)}
            fileName="FinancialExperts"
...
export default FinancialExpertsPage;
