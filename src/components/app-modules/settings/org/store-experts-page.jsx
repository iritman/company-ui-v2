...
import service from "./../../../../services/settings/org/store-experts-service";
import {
...
import StoreExpertModal from "./store-expert-modal";
import StoreExpertDetailsModal from "./store-expert-details-modal";
...
const StoreExpertsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.store_experts}
            searchText={searchText}
            sheets={getSheets(records)}
            fileName="StoreExperts"
...
export default StoreExpertsPage;
