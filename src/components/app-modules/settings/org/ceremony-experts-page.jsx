...
import service from "./../../../../services/settings/org/ceremony-experts-service";
import {
...
import CeremonyExpertModal from "./ceremony-expert-modal";
import CeremonyExpertDetailsModal from "./ceremony-expert-details-modal";
...
const CeremonyExpertsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.ceremony_experts}
            searchText={searchText}
            sheets={getSheets(records)}
            fileName="CeremonyExperts"
...
export default CeremonyExpertsPage;
