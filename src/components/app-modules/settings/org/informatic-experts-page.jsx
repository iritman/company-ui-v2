...
import service from "./../../../../services/settings/org/informatic-experts-service";
import {
...
import InformaticExpertModal from "./informatic-expert-modal";
import InformaticExpertDetailsModal from "./informatic-expert-details-modal";
...
const InformaticExpertsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.informatic_experts}
            searchText={searchText}
            sheets={getSheets(records)}
            fileName="InformaticExperts"
...
export default InformaticExpertsPage;
