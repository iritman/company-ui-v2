...
import service from "../../../../services/settings/timex/mission-requests-service";
...
const MissionRequestsSearchModal = ({ isOpen, filter, onOk, onCancel }) => {
  const {
    progress,
    setProgress,
    record,
  ...
  useMount(async () => {
    ...
    try {
      ...
      const { Members, MissionTypes, Targets, Statuses } = data;
...
export default MissionRequestsSearchModal;
