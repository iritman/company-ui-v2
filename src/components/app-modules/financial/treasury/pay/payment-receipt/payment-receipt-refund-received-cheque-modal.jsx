...
const PaymentReceiptRefundReceivedChequeModal = ({
  isOpen,
  selectedObject,
  cashBoxID,
  selectedCheques,
  ...
  useMount(async () => {
    ...
    try {
      ...
      if (selectedObject) {
        ...
        const selectable_cheques = await service.getReceivedChequesForRefund(
          cashBoxID,
          FrontSideAccountID
        );
        ...
        if (!current_selected_cheque) {
          current_selected_cheque =
            await service.getReceivedChequeForRefundByID(
  ...
  return (
    <ModalWindow
      ...
      onCancel={onCancel}
      title={Words.reg_refund_received_cheque}
      width={1250}
    >
...
export default PaymentReceiptRefundReceivedChequeModal;
