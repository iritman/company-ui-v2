...
import {
  ...
  getNewButton,
  calculatePrice,
} from "./collector-agent-rejection-modal-code";
import ChequeModal from "./collector-agent-rejection-cheque-modal";

const { TabPane } = Tabs;

const formRef = React.createRef();

const CollectorAgentRejectionModal = ({
  access,
  isOpen,
  selectedObject,
  onOk,
  ...
  const handleSaveCheque = async () => {
    if (selectedObject !== null) {
      ...
      const saved_cheque = await onSaveCheque({
        ItemID,
        RejectionID: selectedObject.RejectionID,
        ChequeID,
        Amount,
        PriorCheque,
      });
...
export default CollectorAgentRejectionModal;
