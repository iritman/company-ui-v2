...
const ServiceRequestsSearchModal = ({ isOpen, filter, onOk, onCancel }) => {
  ...
  useMount(async () => {
    ...
    try {
      ...
      const { Statuses, StorageCenters, FrontSideTypes, ServiceRequestTypes } =
        data;
...
export default ServiceRequestsSearchModal;
