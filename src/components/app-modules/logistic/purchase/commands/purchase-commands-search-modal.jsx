...
const schema = {
  CommandID: Joi.number().label(Words.id),
...
const PurchaseCommandsSearchModal = ({ isOpen, filter, onOk, onCancel }) => {
  ...
  useMount(async () => {
    ...
    try {
      ...
      const { RegMembers, Statuses } = data;
...
export default PurchaseCommandsSearchModal;
