...
import service from "../../../../services/official/edocs/user-label-tags-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import TagModal from "./user-label-tag-modal";
...
const UserLabelTagsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
...
export default UserLabelTagsPage;
