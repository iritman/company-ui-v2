...
import service from "./../../../../services/official/edocs/user-folder-groups-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import FolderGroupModal from "./user-folder-group-modal";
...
const UserFolderGroupsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.folder_groups}
            searchText={searchText}
            sheets={getSheets(records)}
            fileName="FolderGroups"
...
export default UserFolderGroupsPage;
