...
import service from "./../../../../services/official/timex/user-official-check-no-alternative-employees-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import NoAlternativeEmployeeModal from "./user-official-check-no-alternative-employee-modal";
import DetailsModal from "./user-official-check-no-alternative-employee-details-modal";
...
const UseOfficialCheckNoAlternativeEmployeesPage = ({ pageName }) => {
  const {
    progress,
    searched,
    searchText,
...
export default UseOfficialCheckNoAlternativeEmployeesPage;
