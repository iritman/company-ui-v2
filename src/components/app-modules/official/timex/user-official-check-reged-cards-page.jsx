...
import service from "./../../../../services/official/timex/user-official-check-reged-cards-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import RegedCardModal from "./user-official-check-reged-card-modal";
import SearchModal from "./user-official-check-reged-cards-search-modal";
import DetailsModal from "./user-official-check-reged-card-details-modal";

const { Text } = Typography;

const getSheets = (records) => [
  {
    title: "OfficialCheckRegedCards",
    data: records,
    columns: [
...
const UserOfficialCheckRegedCardsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    setSearched,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            ...
            fileName="OfficialCheckRegedCards"
...
export default UserOfficialCheckRegedCardsPage;
