...
import {
  getStatusColor,
  getStatusTitle,
} from "../../../common/extra-works-page-items";

const { Text } = Typography;

const UserApprovedExtraWorkDetailsModal = ({
  extraWorkRequest,
  isOpen,
  onOk,
}) => {
          ...
          <Col xs={24}>
            ...
            >
              <Descriptions.Item label={Words.status}>
                <Text style={{ color: getStatusColor(extraWorkRequest) }}>
                  {getStatusTitle(extraWorkRequest)}
                </Text>
              </Descriptions.Item>
...
export default UserApprovedExtraWorkDetailsModal;
