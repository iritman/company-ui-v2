...
import { Row, Col, Typography, Alert, Descriptions, Divider, Tag } from "antd";
...
const ExtraWorkRequestDetails = ({ extraWorkRequest }) => {
      ...
      <Col xs={24}>
        ...
        >
          <Descriptions.Item label={Words.status}>
            <Text style={{ color: getRequestStatusColor(extraWorkRequest) }}>
...
export default ExtraWorkRequestDetails;
