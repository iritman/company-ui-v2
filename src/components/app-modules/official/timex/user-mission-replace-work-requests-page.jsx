...
import SearchModal from "./user-mission-replace-work-request-search-modal";
import DetailsModal from "./user-mission-replace-work-request-details-modal";
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            ...
            sheets={getSheets(records, "MissionReplaceWorkRequests")}
