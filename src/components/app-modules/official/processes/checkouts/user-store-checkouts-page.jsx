...
import service from "../../../../../services/official/processes/user-store-checkouts-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import SearchModal from "./user-store-checkouts-search-modal";
import DetailsModal from "./user-store-checkout-details-modal";
...
const UserStoreCheckoutsPage = ({ pageName }) => {
  const {
    progress,
    searched,
    setSearched,
...
export default UserStoreCheckoutsPage;
