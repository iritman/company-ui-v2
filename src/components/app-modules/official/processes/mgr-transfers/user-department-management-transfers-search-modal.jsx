...
const schema = {
  ...
  JustUnseenTransfers: Joi.boolean(),
};
...
const initRecord = {
  ...
  FromDate: "",
  ToDate: "",
  JustUnseenTransfers: false,
};

const formRef = React.createRef();

const UserDepartmentManagementTransfersSearchModal = ({
  isOpen,
  filter,
  onOk,
  onCancel,
  ...
  const clearRecord = () => {
    ...
    record.FromDate = "";
    record.ToDate = "";
    record.JustUnseenTransfers = true;
    ...
    >
      <Form ref={formRef} name="dataForm">
        <Row gutter={[10, 5]} style={{ marginLeft: 1 }}>
          ...
          <Col xs={24}>
            <SwitchItem
              title={Words.just_unseen_transfers}
              fieldName="JustUnseenTransfers"
              initialValue={true}
...
export default UserDepartmentManagementTransfersSearchModal;
