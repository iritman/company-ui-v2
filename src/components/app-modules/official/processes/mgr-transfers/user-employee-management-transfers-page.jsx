...
import service from "../../../../../services/official/processes/user-employee-management-transfers-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
import SearchModal from "./user-employee-management-transfers-search-modal";
import DetailsModal from "./user-employee-management-transfer-details-modal";
...
const UserEmployeeManagementTransfersPage = ({ pageName }) => {
  const {
    progress,
    searched,
    setSearched,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.management_transfer_employee}
...
export default UserEmployeeManagementTransfersPage;
