...
import SearchModal from "./user-archived-announces-search-modal";
...
const UserArchivedAnnouncesPage = ({ pageName }) => {
  const {
    progress,
    setProgress,
    searched,
...
export default UserArchivedAnnouncesPage;
