...
import OthersTaskModal from "./user-others-task-modal";
import SearchModal from "./user-others-tasks-search-modal";
...
const UserOthersTasksPage = ({ pageName }) => {
  const {
    progress,
    setProgress,
    searched,
...
export default UserOthersTasksPage;
